...
public class Main {
    public static void main(String[] args)throws NumberFormatException, IOException {
        Benda cpugaming = new Cpu();
        BendaUser hada = new BendaUser(cpugaming);
        hada.nyalakanbenda();
      ...
      while(true){
        ...
        System.out.println("==============================================");
        System.out.println("----------------------------------------------------");
        System.out.println("1. Nyalakan sistem");
        System.out.println("2. Tambah Daftar Perbaikan");
        System.out.println("3. Lihat Daftar Perbaikan"); 
        System.out.println("4. Ubah Daftar Perbaikan");
        System.out.println("5. Hapus Daftar Perbaikan");
        System.out.println("6. Matikan sistem");
